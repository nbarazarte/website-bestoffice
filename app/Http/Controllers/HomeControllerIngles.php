...
class HomeControllerIngles extends Controller
{
    ...
    public function index()
    {
        ...
        return \View::make('en.index', compact('productos'));
    ...
    public function site()
    {
          ...
          return response()->view('en.sitemap')->header('Content-Type', 'text/xml');
...
*/
    ...
    public function colorear()
    {
        ...
        */
        ...
        return \View::make('en.colorear',compact('files'));
    ...
    public function contacto()
    {
        ...
        return \View::make('en.contactanos');
